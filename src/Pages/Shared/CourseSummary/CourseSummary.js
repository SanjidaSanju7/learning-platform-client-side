...
const CourseSummary = ({ course }) => {
    ...
    const { name, publisher, image, description, rating, total_view } = course;


    return (

        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-lg dark:text-gray-100 about-card mb-5">
